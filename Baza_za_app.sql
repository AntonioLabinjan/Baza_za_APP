...
ALTER TABLE Uloga MODIFIY COLUMN id INT AUTO_INCREMENT;
...
id_uloga INT,
FOREIGN KEY (id_uloga) REFERENCES Uloga(id)
);

ALTER TABLE Korisnik MODIFY COLUMN  id INT AUTO_INCREMENT;
